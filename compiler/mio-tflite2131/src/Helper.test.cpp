...
#include "mio_tflite2131/Helper.h"
...
class mio_tflite2131_helper_test : public ::testing::Test
{
protected:
 ...
 */
TEST_F(mio_tflite2131_helper_test, v3)
{
...
TEST_F(mio_tflite2131_helper_test, v3_custom)
{
  // BuiltinOperator_ADD = 0
...
TEST_F(mio_tflite2131_helper_test, v3_NEG)
{
  // BuiltinOperator_ADD = 0
...
TEST_F(mio_tflite2131_helper_test, v3a_under127)
{
  // BuiltinOperator_CONV_2D = 3
...
TEST_F(mio_tflite2131_helper_test, v3a_under127_NEG)
{
  // BuiltinOperator_CONV_2D = 3
  // BuiltinOperator_CUMSUM = 128
  // deprecated_builtin_code cannot be negative value
...
TEST_F(mio_tflite2131_helper_test, v3a_custom)
{
  // BuiltinOperator_CUSTOM = 32
...
TEST_F(mio_tflite2131_helper_test, v3a_custom_NEG)
{
  // BuiltinOperator_CUMSUM = 128
  // deprecated_builtin_code cannot be negative value
...
TEST_F(mio_tflite2131_helper_test, v3a_over127)
{
...
TEST_F(mio_tflite2131_helper_test, v3a_over127_NEG)
{
  // BuiltinOperator_CUMSUM = 128
  // deprecated_builtin_code cannot be negative value
